      ...
      <div className>
        <div className="relative flex justify-center items-center bg-no-repeat bg-cover bg-[url('https://i.ibb.co/8MC6MDV/download.png')] h-[100vh] bg-opacity-10">
          ...
          <div className="text-center z-20 opacity-90">
                    <h1 className="text-5xl font-bold text-purple-200 text-center leading-[60px]">Rev Up Your Dreams with Our Unbeatable <br /> Car Selection
                    </h1>
                    <p className="text-xl font-semibold text-white text-center leading-7 mt-10 mb-8">Find Your Dream Ride at Mz Cars Shop. Discover a wide range of cars to suit <br /> your style and needs. Your perfect car is just a click away!</p>
